...
+(UIImage*)imageFromPathFileName:(NSString *)name{
    ...
    if ([name containsString:@".png"]) {
        type = @"png";
        tempName = [name stringByReplacingOccurrencesOfString:@".png" withString:@""];
    }
    else if ([name containsString:@".jpg"])
    {
        type = @"jpg";
        tempName = [name stringByReplacingOccurrencesOfString:@".jpg" withString:@""];
    }
    else{
    }
    if (kIPhone55inch) {
    ...
    NSString *useString=0x00;
    
    NSString *tempString=[[NSBundle mainBundle]pathForResource:tempName ofType:type inDirectory:@""];
    
    NSString *tempString2=[[NSBundle mainBundle]pathForResource:[NSString stringWithFormat:@"%@@2x",tempName] ofType:type inDirectory:@""];
    NSString *tempString3=[[NSBundle mainBundle]pathForResource:[NSString stringWithFormat:@"%@@3x",tempName] ofType:type inDirectory:@""];
    if (is3X) {
        if (tempString3==nil) {
            if (tempString2==nil) {
                useString=tempString;
            }
            else{
                useString=tempString2;
            }
        }
        else{
            useString=tempString3;
        }
    }
    else{
        if (tempString2==nil) {
    ...
    return [UIImage imageWithContentsOfFile:useString];
}
