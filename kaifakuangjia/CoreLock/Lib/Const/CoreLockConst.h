 ...
 *  背景色
 */ 
#define CoreLockViewBgColor [UIColor clearColor]

/*
 *  外环线条颜色：默认
 */

#define CoreLockCircleLineNormalColor [UIColor clearColor]

#define CoreLockTitleNormalColor [UIColor whiteColor]
/*
 *  外环线条颜色：选中
 */
 ...
 *  实心圆
 */
#define CoreLockCircleLineSelectedCircleColor [UIColor clearColor]
 ...
 *  警示文字颜色
 */
#define CoreLockWarnColor  kDNColorFromRGB(0xf71313)
